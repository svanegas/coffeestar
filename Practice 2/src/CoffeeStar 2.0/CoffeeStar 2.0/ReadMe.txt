========================================================================
    APLICACIÓN DE CONSOLA: CoffeeStar 2.0 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación CoffeeStar 2.0.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación CoffeeStar 2.0.


CoffeeStar 2.0.vcxproj
...
CoffeeStar 2.0.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado CoffeeStar 2.0.pch y un archivo de tipos 
